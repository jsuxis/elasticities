...
program define cardlemieuxind, rclass
	...
	sort altersgr ind jahr
	by altersgr ind: gen t = _n
	gen t2=t*t
...
* First Step
	...
	// genreally higher F stats with original instrument
	forval i=1/7 {
		ivreg2 logwage i.jahr i.altersgr (loglabor = lagged) if ind==`i', robust
		scalar F2_`i' = e(widstat)
		ivreg2 logwage i.jahr i.altersgr (loglabor = loglabortotal) if ind==`i', robust 
		mat temp_`i' = e(b)
		scalar F1_`i' = e(widstat)
